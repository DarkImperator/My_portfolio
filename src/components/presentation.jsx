  ...
  return (
    <div className="container_pres">
      ...
      <div className="description_pres">
        {/* <p>Après plusieurs expériences professionnelles dans plusieurs domaines, j'ai décidé de me reconvertir dans le développement web et je reviens vers un des mes centres d'intérêts de ma jeunesse pour en faire ma profession. Créatif et curieux, j'ai toujours chercher à comprendre et résoudre des problèmes techniques.</p> */}
        <p>
          {
